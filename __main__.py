...
app_path = config.get("appPath", "./az-function")
...
resource_group = azure.resources.ResourceGroup("python-api-sample")
...
synced_folder = synced.AzureBlobFolder(
    "python-api-sample-synced-folder",
    path=www_path,
    resource_group_name=resource_group.name,
...
app_container = azure.storage.BlobContainer(
    "python-api-sample-app-container",
    account_name=account.name,
    resource_group_name=resource_group.name,
